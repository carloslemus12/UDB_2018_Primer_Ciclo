<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Retirar.aspx.cs" Inherits="Depositar" %>
           ...
           <div class="row">
            ...
            <div class="card-footer text-muted p-0">
                <div class="form-group col mt-2 w-100 d-flex justify-content-md-between">
                    <asp:Button ID="btn_aceptar" runat="server" Text="Retirar" CssClass="btn btn-success" OnClick="btn_aceptar_Click"/>
